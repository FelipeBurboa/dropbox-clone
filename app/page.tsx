  ...
  return (
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919] dark:bg-slate-800">
        <div className="p-10 flex flex-col bg-[#1E1919] dark:bg-slate-800 text-white space-y-5">
          ...
          <p className="pb-20">
            Enhance your personas storage with Dropbox, offering a simple and
        ...
        <div className="bg-[#1E1919] dark:bg-slate-800 h-full p-10">
          <video autoPlay muted loop className="rounder-lg">
            <source
